...
if ret:
    while True:
        ...
        if ret:
            ...
            # Aplicar el modelo de spaCy NER al texto extraído
        ...
        # Aumentar el tiempo actual en 1 segundo (1000 ms)
        tiempo_actual += 1 * fps  # Multiplicar por fps para obtener el número de fotogramas en 1 segundo
